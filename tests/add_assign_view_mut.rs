    ...
    macro_rules! blas {
        ($ty:ident) => {
            mod $ty {
                ...
                // Test that `add_assign(&Trans<Mat>)` is correct for `MutView`
                #[quickcheck]
                fn mat(
                    start: (usize, usize),
                ...
                // Test that `add_assign(&Trans<View>)` is correct for `MutView`
                #[quickcheck]
                fn view(
                ...
                // Test that `add_assign(&Trans<MutView>)` is correct for `MutView`
                #[quickcheck]
                fn view_mut(
                    (lhs_start, rhs_start): ((usize, usize), (usize, usize)),
                    (nrows, ncols): (usize, usize),
...
macro_rules! blas {
    ($ty:ident) => {
        mod $ty {
            ...
            // Test that `add_assign(&Mat)` is correct for `MutView`
            #[quickcheck]
            fn mat(
                start: (usize, usize),
                (nrows, ncols): (usize, usize),
            ...
            // Test that `add_assign(&T)` is correct for `MutView`
            #[quickcheck]
            fn scalar(
                start: (usize, usize),
                (nrows, ncols): (usize, usize),
            ...
            // Test that `add_assign(&View)` is correct for `MutView`
            #[quickcheck]
            fn view(
                (lhs_start, rhs_start): ((usize, usize), (usize, usize)),
                (nrows, ncols): (usize, usize),
            ...
            // Test that `add_assign(&MutView)` is correct for `MutView`
            #[quickcheck]
            fn view_mut(
                (lhs_start, rhs_start): ((usize, usize), (usize, usize)),
                (nrows, ncols): (usize, usize),
